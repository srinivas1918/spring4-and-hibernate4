 ...
 <div class="modal-content" >
    	...
    	<div class="row mt " style="padding-top: 7px; font-size: 19px; margin-left: 8px;  margin-right: 5px; " >
    	 ...
    	 <table class="table table-bordered table-striped table-condensed" style="font-size: 15px;" >
    	  ...
    	  <B style="color: green;">Tracking History:</B>
    	  <table class="table table-bordered table-striped table-condensed" style="font-size: 15px;" >
    	 	<thead>
    	 		<tr>
    	 						<th>#SNO</th>
    	 	...
    	 	<tbody >
    	 			...
    	 			<c:forEach var="items" items="${customer.trackings }" varStatus="counter">
    	 				<tr>
    	 					<td>${counter.count }</td>
    	 					<td style="color: green;"><b>${items.followUpDate }</b></td>
